...
function ConfrimRidePopup({setRidepopup,setConfirmRidepopup}) {
    return (
        <>
          {" "}
          <div className=" bg-slate-50 h-full w-full absolute top-2">
            ...
            <div className="flex flex-col items-center gap-1">
              <button className="w-11/12 bg-green-400 text-white py-2 rounded-lg">
                Confirm
              </button>
